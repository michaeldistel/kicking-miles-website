...
console.log('🔄 Updating Japan 2017 gallery types to "square"...\n');
...
for (const dayDir of dayDirs) {
    ...
    try {
        ...
        // Update gallery type from "mixed" to "square"
        ...
        if (content !== updatedContent) {
            ...
            console.log(`✅ Updated ${dayDir}: mixed → square`);
            updatedCount++;
        } else {
...
console.log(`\n📊 Summary: Updated ${updatedCount} files to use "square" gallery type`);
console.log('\n🎨 Japan 2017 photos will now display with square aspect ratios!');
